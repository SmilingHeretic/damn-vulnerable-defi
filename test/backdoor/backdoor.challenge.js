...
describe('[Challenge] Backdoor', function () {
    ...
    it('Exploit', async function () {
        ...
        this.attackContract = await BackdoorAttackFactory.deploy(
            this.masterCopy.address, this.walletFactory.address, this.token.address, this.walletRegistry.address, users
        )
    });
