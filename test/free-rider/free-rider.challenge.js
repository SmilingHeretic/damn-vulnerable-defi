...
describe('[Challenge] Free Rider', function () {
    ...
    it('Exploit', async function () {
        ...
        this.attackContract = await FreeRiderAttackFactory.deploy(
            this.uniswapPair.address, this.marketplace.address, this.nft.address, this.weth.address, this.buyerContract.address,
